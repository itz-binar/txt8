...
rem if "%1" == "null" (
	...
	del ".\BNG MODS\0.32\mods\DongFeng_DFL_T375.zip"
	del ".\BNG MODS\0.32\mods\奔驰卡车.zip"
...
for %%i in (%*) do (
	...
	if "%%i" == "fengtian-hanlanda" (
		...
		rem 拷贝 东风卡车拉到模组目录
	if "%%i" == "dongfengkache" (
		copy ".\lxmod\DongFeng_DFL_T375.zip" ".\BNG MODS\0.32\mods\DongFeng_DFL_T375.zip"
	)
	rem 拷贝 奔驰卡车拉到模组目录
	if "%%i" == "bencikache" (
		copy ".\lxmod\奔驰卡车.zip" ".\BNG MODS\0.32\mods\奔驰卡车.zip"
	)
)
